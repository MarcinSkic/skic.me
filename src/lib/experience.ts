...
export const experience: Experience[] = [
  {
    began_at: new Date("2024-10-01"),
    title: "Comarch",
    description: `I am part of a team developing new module for HR system, made in microservices architecture.`,
    roles: ["developer"],
    category: "fullstack",
  },
  {
    began_at: new Date("2024-04-01"),
    finished_at: new Date("2024-05-01"),
    title: "Parleto",
    description: `I implemented new features and migrated components from Vue2 to Quasar (Vue3).`,
