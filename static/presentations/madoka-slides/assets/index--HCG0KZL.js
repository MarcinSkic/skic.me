(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`<section class="overflow-hidden">
  ...
  <aside class="notes">Przedstaw się</aside>
</section>
`,t=`<section>
  <img
    src="assets/intro/sayaka-no-spoiler.png"
    class="h-200 top-20 left-1/2 -translate-x-1/2 fragment"
    alt="SPOILERS AHEAD"
  />
  <h2
  ...
  <aside class="notes">
    <ol>
      <li>
        ...
        chce więcej mocy just because
      </li>
      <li>żeby mieć energię żeby walczyć z entropią</li>
      <li>bo ma legitny potencjał energetyczny</li>
      <li>
      ...
      <li>kyuubey just being funny (gatunek MS budulec)</li>
      <li>
      ...
      <li>
        Dwa powody
        <ol>
          <li>powód filozoficzny, podtrzymywanie swojego życzenia</li>
          <li>
      ...
      <li>
        ...
        wiedźmy zanim jeszcze powstaną, to była w stanie swoją własną wiedźmę
        usunąć (łamie prawo przyczyny i skutku)
      </li>
    </ol>

    <p>Dużo jest budulcem gatunku MS</p>
    <ul>
...
`,p=`<section>
  ...
  <ul class="list-disc left-30 top-70 font-medium flex flex-col gap-2 text-4xl">
    ...
    <li class="fragment">Naciska i wywiera presję czasu</li>
  ...
  <aside class="notes">
    <ol>
      ...
      <li>
        ...
        <ol>
          ...
          <li>tłumaczy mechanikę spamowania maną, ale nie wyjaśnia skutków</li>
        </ol>
      </li>
      <li>
        <strong>Wyczuwa na czym każdemu zależy i używa to przeciw nim</strong>
        <ol>
          <li>Madoka przyznaje się, że chciałaby być silniejsza</li>
          <li>
            Widzi dynamikę relacji Sayaka – Kyouko i wykorzystuje ją najpierw
            żeby walczyły ze sobą, a następnie żeby Kyouko się poświęciła i
            Homura nie miała szans z Walpurgisnachtem
          </li>
        </ol>
      </li>
      <li>
        <strong>Naciska i wywiera presję czasu</strong>
        <ul>
          <li>Naciskanie Madoki, że będzie silna</li>
          <li>
            Traci panowanie jak mogą umrzeć (ep3). Czysta kalkulacja, że lepiej
            żeby umarły dając mi korzyść
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            ...
            że "jakby nie on to PRAWDOPODOBNIE byście dalej żyli w jaskiniach".
            Btw w scenie pokazywania przeszłości MS przypieczętowuje swój los
          </li>
          <li>
      ...
      <li>
        ...
        <ul>
          ...
          <li>Zaprasza Kyouko znając jej charakter (ep4)</li>
          <li>Mówi Sayace, że Madoka mogłaby pomóc (ep7)</li>
        </ul>
      </li>
      <li>
    ...
    <p>Wspomnij o wykorzystaniu gatunku MS</p>
  </aside>
</section>
`,m=`<section>
  <img
